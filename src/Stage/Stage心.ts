...
export default class extends Stage {
    protected *G(): Generator<void, void, unknown> {
        ...
        yield* this.text("「レトリックは止めろよ。嫌いなんだ。合成人にも、人と同じ心が在るのか、気になって。」", { name: "シオン" })
        yield* this.text("「じゃあ俺に心が在るかはどうなんだ?」", { name: "マス" })
        yield* this.text("「……。」", { name: "シオン" })
        yield* this.text("「俺たちに見えるものは、関わり合いだけだ。そして、俺たちにとって重要な事も、関わり合いだけだ。」", { name: "マス" })
        yield* this.text("「超関数?」", { name: "シオン" })
        yield* this.text("「俺は縁起と云いたいね。」", { name: "マス" })
