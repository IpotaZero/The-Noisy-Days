...
import { g, raycastToEdge, scorenize, T } from "../../global"
...
class Core extends Enemy {
    ...
    constructor() {
        super(600, 60, new EnemyRendererCore(), { remainingCharge: 300, margin: 60 })
        ...
        remodel()
            ...
            .g(function* (me) {
                ...
                for (let i = 0; i < frame; i++) {
                    me.color = `hsl(${Math.floor((i / frame) * 140 + 180)}, 50%, 50%)`
                    yield
                }

                yield* GenUtils.parallel(Remodel.ease(me, "radian", T + T / 4, 360, Ease.Linear), e)
        ...
        for (let i = 1; i < frame + 1; i++) {
            remodel()
                ...
                .duplicate(3, (me, i) => {
                    ...
                    me.speed = (Math.sin(this.frame ** 3 + i) * T) / 3 + 1
                    return me
                })
                .fire()
            yield* Array(3)
