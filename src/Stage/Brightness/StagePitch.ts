...
class FortressCore extends Enemy {
    ...
    constructor() {
        super(1000, 80, new EnemyRendererCore(), { margin: 90, remainingCharge: 1200 })
    ...
    *H() {
        ...
        remodel(this)
            ...
            .beam(this, 0)
            .g(function* (me) {
                yield* Remodel.ease(me, "length", g.height, 30, Ease.InOut)
                yield* Remodel.ease(me, "radian", T / 4 + T, 120, Ease.InOut)
